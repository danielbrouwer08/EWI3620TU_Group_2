...
public class PlayerController : MonoBehaviour
{
	...
	//Returns true if the player is located on a ground where he can jumps.
	public bool grounded ()
	{
	...
	//Another script can call this to add a force to the player. Nomovementtime indicates how long the player will be unable to move after receiving this force.
	...
	//Get the last saved position from the gamemanager.
